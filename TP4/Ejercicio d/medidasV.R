calculateMedidas<-function(i){	
	...
	p <- read.csv(paste('/home/gabina/Facultad/Machine Learning/TP4/Ejercicio d/datosProcesadosA',i,'.txt',sep=""))
	...
	#Leo los 20 valores de test
	p <- read.csv(paste('/home/gabina/Facultad/Machine Learning/TP4/Ejercicio d/datosProcesadosB',i,'.txt',sep=""))
