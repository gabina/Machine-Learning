...
int train(char *filename){
  ...
  /*imprimir medias y vars */
     printf("\n\nMedias y varianzas calculadas");
  for (clase=0;clase<N_Class;clase++){
    printf("\nclase %d) ",clase);        
    for (feature=0;feature<N_IN;feature++)
      printf("%f,%f  ",mediaTrain[feature][clase],deTrain[feature][clase]);
  }
     printf("\n");    
