#!/bin/bash
		...
		echo "Test" >> test.txt
		grep "Test:" DosElipses/dos_elipses.resultados >> auxiliar1.txt
		...
		grep "Validacion:" DosElipses/dos_elipses.resultados >> auxiliar1.txt
		...
		grep "Entrenamiento:" DosElipses/dos_elipses.resultados >> auxiliar1.txt
